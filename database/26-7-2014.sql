...
-- Dumping data for table akcms.lookup: ~16 rows (approximately)
DELETE FROM `lookup`;
...
INSERT INTO `lookup` (`idc`, `parentId`, `selectable`, `editable`, `description`, `alias`, `link`, `createdOn`, `createdBy`, `lastUpdatedOn`, `lastUpdatedBy`) VALUES
	...
	(19, 1, 1, 0, 'PAGE_TYPES', 'PAGE_TYPES', '0', '2014-07-25 23:33:50', 1, '2014-07-25 23:33:50', 1),
	(21, 19, 1, 0, 'PAGE', 'PAGE', '0', '2014-07-25 23:36:23', 1, '2014-07-25 23:36:23', 1),
	(22, 19, 1, 0, 'ARTICLE', 'ARTICLE', '0', '2014-07-25 23:36:32', 1, '2014-07-25 23:36:32', 1),
	(23, 19, 1, 0, 'PRODUCT', 'PRODUCT', '0', '2014-07-25 23:36:41', 1, '2014-07-25 23:36:41', 1),
	(24, 1, 1, 0, 'LANGAUGES', 'LANGAUGES', '0', '2014-07-26 00:16:26', 1, '2014-07-26 00:16:26', 1),
	(25, 24, 1, 0, 'GREEK', 'gr', '0', '2014-07-26 00:17:19', 1, '2014-07-26 00:17:19', 1),
	(26, 24, 1, 0, 'ENGLISH', 'en', '0', '2014-07-26 00:17:35', 1, '2014-07-26 00:17:35', 1);
...
-- Dumping structure for table akcms.orderitems
CREATE TABLE IF NOT EXISTS `orderitems` (
  ...
  KEY `FK_orderitems_person` (`createdBy`),
  KEY `FK_orderitems_person_2` (`lastUpdatedBy`),
  CONSTRAINT `FK_orderitems_person` FOREIGN KEY (`createdBy`) REFERENCES `person` (`idc`),
  CONSTRAINT `FK_orderitems_person_2` FOREIGN KEY (`lastUpdatedBy`) REFERENCES `person` (`lastUpdatedBy`),
  CONSTRAINT `FK_orderitems_order` FOREIGN KEY (`orderId`) REFERENCES `order` (`idc`),
  CONSTRAINT `FK__page` FOREIGN KEY (`pageId`) REFERENCES `page` (`idc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table akcms.orderitems: ~0 rows (approximately)
...
INSERT INTO `page` (`idc`, `typeId`, `title`, `slug`, `subtitle`, `content`, `price`, `sku`, `quantity`, `createdOn`, `createdBy`, `lastUpdatedOn`, `lastUpdatedBy`) VALUES
	(1, 21, 'Home', 'home', 'the home page', 'The home page content', 0, '', 0, '2014-07-25 23:40:36', 1, '2014-07-25 23:40:36', 1),
	(2, 21, 'Contact', 'contact', 'the contact page', 'The contact page content', 0, '', 0, '2014-07-25 23:41:06', 1, '2014-07-25 23:41:06', 1);
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `INSERT_LOOKUP`(IN `PARENT` INT, IN `SELECTABLE` INT, IN `EDITABLE` INT, IN `DESCRIPTION` VARCHAR(50))
BEGIN
